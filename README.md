...
La app muestra su versión en el header (`v10.5`) y, en **Ajustes → Versión**, la compara con la que publica el backend: así se ve si el navegador quedó con una copia cacheada o si falta re-deployar el Apps Script. El botón **Buscar actualizaciones** borra el cache y recarga.
